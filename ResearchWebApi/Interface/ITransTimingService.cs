...
namespace ResearchWebApi.Interface
{
    public interface ITransTimingService
    {
        ...
        bool TimeToBuyCheckingByBias(double currentPrice, double? shortMaVal, int buyBiasPercentage);
        ...
        bool TimeToSellCheckingByBias(double currentPrice, double? shortMaVal, int sellBiasPercentage);
