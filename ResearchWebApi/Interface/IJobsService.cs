...
namespace ResearchWebApi.Interface
{
    public interface IJobsService
    {
        ...
        void TrainGNQTSWithBias(SlidingWinPair pair, string symbol, Period period, bool isCRandom);
        ...
        void TrainTraditionalWithBias(SlidingWinPair pair, string symbol, Period period);
